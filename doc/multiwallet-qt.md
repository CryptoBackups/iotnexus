...
Only requiring some minor changes is iotnexus.cpp.
...
Changes to iotnexus.cpp
----------------------
iotnexus.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
