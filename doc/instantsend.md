...
This mechanism has been integrated into Bitcore-Node-IoTNexus which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/iotnexuscoin/insight-api-iotnexus#web-socket-api](https://github.com/iotnexuscoin/insight-api-iotnexus#web-socket-api)
* API: [https://github.com/iotnexuscoin/insight-api-iotnexus#instantsend-transactions](https://github.com/iotnexuscoin/insight-api-iotnexus#instantsend-transactions)
...
By default, the IoT Nexus daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the IoT Nexus daemon:
