...
IoT Nexus is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as IoT Nexus, where everyone uses
...
pay attention to for reviewers of IoT Nexus code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: IoT Nexus uses tinyformat, which is type safe. Leave them out to avoid confusion
