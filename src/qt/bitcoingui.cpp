                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("IoT Nexus") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a IoTNexus address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and iotnexus: URIs)"));
...
//AAAA LimxDev Coinmix Tab
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About IoT Nexus"), this);
    aboutAction->setStatusTip(tr("Show information about IoT Nexus"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for IoT Nexus"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your IoTNexus addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified IoTNexus addresses"));
    ...
    openAction->setStatusTip(tr("Open a IoT Nexus: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the IoT Nexus help message to get a list with possible IoT Nexus command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("IoT Nexus client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to IoTNexus network", "", count));
}
...
{
    QString strTitle = tr("IoT Nexus"); // default title
