...
/** Utility functions used by the IOTN Qt UI.
 */
namespace GUIUtil
{
...
// Render IOTN addresses in monospace font
...
// Parse "iotnexus:" URI into recipient object, return true on successful parsing
