...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("IoT Nexus iotnexus-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  iotnexus-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded iotnexus transaction") + "\n" +
                               "  iotnexus-tx [options] -create [commands]   " + _("Create hex-encoded iotnexus transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded iotnexus transaction
