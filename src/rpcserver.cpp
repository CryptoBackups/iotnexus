...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop IoT Nexus server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "IoT Nexus server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* IOTN features */
        {"iotnexus", "masternode", &masternode, true, true, false},
        {"iotnexus", "masternodelist", &masternodelist, true, true, false},
        {"iotnexus", "mnbudget", &mnbudget, true, true, false},
        {"iotnexus", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"iotnexus", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"iotnexus", "mnsync", &mnsync, true, true, false},
        {"iotnexus", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"iotnexus", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use iotnexusd, or the -server option to iotnexus-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> iotnexus-cli " + methodname + " " + args + "\n";
}
