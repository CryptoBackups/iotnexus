...
RESOURCES += src/qt/iotnexus.qrc src/qt/iotnexus_locale.qrc

TRANSLATIONS += src/qt/locale/iotnexus_bg.ts \
                src/qt/locale/iotnexus_de.ts \
                src/qt/locale/iotnexus_en.ts \
                src/qt/locale/iotnexus_es.ts \
                src/qt/locale/iotnexus_fi.ts \
                src/qt/locale/iotnexus_fr.ts \
                src/qt/locale/iotnexus_it.ts \
                src/qt/locale/iotnexus_ja.ts \
                src/qt/locale/iotnexus_pl.ts \
                src/qt/locale/iotnexus_pt.ts \
                src/qt/locale/iotnexus_ru.ts \
                src/qt/locale/iotnexus_sk.ts \
                src/qt/locale/iotnexus_sv.ts \
                src/qt/locale/iotnexus_vi.ts \
                src/qt/locale/iotnexus_zh_CN.ts \
                src/qt/locale/iotnexus_zh_TW.ts
